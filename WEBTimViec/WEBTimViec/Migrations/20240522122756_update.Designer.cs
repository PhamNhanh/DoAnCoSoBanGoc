...
namespace WEBTimViec.Migrations
{
    ...
    [Migration("20240522122756_update")]
            ...
            modelBuilder.Entity("WEBTimViec.Models.BaiTuyenDung", b =>
                {
                    ...
                    b.Property<int?>("KyNangMemKNMemid")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WEBTimViec.Models.KyNangMem", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KNMemid"));
            ...
            modelBuilder.Entity("WEBTimViec.Models.BaiTuyenDung", b =>
                {
                    ...
                    b.HasOne("WEBTimViec.Models.KyNangMem", "KyNangMem")
                        .WithMany()
                        .HasForeignKey("KyNangMemKNMemid");
